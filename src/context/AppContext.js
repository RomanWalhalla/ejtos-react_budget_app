...
// import { initialState } from "../components/Budget"
...
export const AppProvider = (props) => {
    ...
    // console.log("Value" + " " + values.budgets)
    const { values } = props
    // console.log("Values +++++++++++" + " " + values.budgets)
    ...
    // const handleBudgetChange = (budgets) => {
    //     setBudget(budgets)
    // }
